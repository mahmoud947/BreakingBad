...
fun CharacterEntity.toFavoriteEntity(): FavoriteCharacterEntity = FavoriteCharacterEntity(
    appearance = this.appearance,
    better_call_saul_appearance = this.better_call_saul_appearance,
    birthday = this.birthday,
    category = this.category,
...
fun FavoriteCharacterEntity.toCharacterEntity(): CharacterEntity = CharacterEntity(
    appearance = this.appearance,
    better_call_saul_appearance = this.better_call_saul_appearance,
    birthday = this.birthday,
    category = this.category,
...
@JvmName("toDomainFavoriteCharacterEntity")
fun List<FavoriteCharacterEntity>.toDomain() = map {
